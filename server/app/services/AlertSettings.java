 ...
 * @param unescapedDescription true to use an unescaped description (th:utext).
 *                             false otherwise.
...
public record AlertSettings(
  ...
  public static class AlertSettingsBuilder {
    ...
    public AlertSettings build() {
      return new AlertSettings(show, title, text, unescapedDescription, alertType, additionalText, isSlim);
    }
  }
}