...
public class NorthStarAddressCorrectionBlockView extends NorthStarBaseView {
    ...
    public String render(
        ...
        String pageTitle = pageTitleWithBlockProgress(
                params.programTitle(),
                params.blockIndex(),
        ...
        // Progress bar
        ProgressBar progressBar = new ProgressBar(params.blockList(), params.blockIndex(), params.messages());
        ...
        String alertMessage = anySuggestions
        ...
        AlertSettings addressAlertSettings = AlertSettings.builder()
                .show(true)
                .title(Optional.of(params.messages().at(MessageKey.ADDRESS_CORRECTION_LINE_1.getKeyName())))
                .text(alertMessage)
